        ...
        <div className="w-full pr-10 pl-10">
            <div className="z-1 text-center flex flex-col flex-nowrap items-center relative">
                ...
                <div className="flex gap-x-8 gap-y-8 justify-center mt-4 mr-auto mb-6 ml-auto">
                    ...
                    <img src="https://cdn.prod.website-files.com/66796a37e9aadbf3722c4340/669130989c67d1028935aaf6_Accel%20Logo.svg" className="h-[2rem] bg-blue-900 p-2 rounded-b-full align-middle max-w-full inline-block max-md:w-[25%]" />
                    <div className="border-l-2"></div>
                    <img src="https://cdn.prod.website-files.com/66796a37e9aadbf3722c4340/66913098bd75e9011141f6d4_MerakiLabs%20Logo.png" className="h-[2rem] bg-blue-900 p-2 rounded-full align-middle max-w-full inline-block max-md:w-[25%] " />
                </div>
